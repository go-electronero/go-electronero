...
import (
	...
	"github.com/go-electronero/Go-Electronero/crypto/signify"
	"github.com/go-electronero/Go-Electronero/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/go-electronero/Go-Electronero/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/go-electronero/Go-Electronero/mobile")
