...
import (
	...
	"github.com/bloc-chain/go-blocChain/crypto/signify"
	"github.com/bloc-chain/go-blocChain/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/bloc-chain/go-blocChain/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/bloc-chain/go-blocChain/mobile")
