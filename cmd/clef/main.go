...
import (
	...
	"github.com/bloc-chain/go-blocChain/cmd/utils"
	...
	"github.com/bloc-chain/go-blocChain/signer/core"
	"github.com/bloc-chain/go-blocChain/signer/core/apitypes"
	"github.com/bloc-chain/go-blocChain/signer/fourbyte"
	"github.com/bloc-chain/go-blocChain/signer/rules"
	"github.com/bloc-chain/go-blocChain/signer/storage"
...
var (
	...
	chainIdFlag = cli.Int64Flag{
		...
		Usage: "Chain id to use for signing (777=mainnet, 6969=testnet, 420420=kekistan, 42069=kektest, 3=Ropsten, 4=Rinkeby, 5=Goerli)",
	}
...
func checkFile(filename string) error {
	...
	// https://github.com/bloc-chain/go-blocChain/issues/20123
